...
var budgetController = (function() {
    ...
    return {
        ...
        addItems: function(type, des, val) {
            ...
            // Creating a new item based on exp and inc
            if(type === 'exp') {
            ...
            // Returning newly added data through an object
            return newitems;
        },
        ...
        calculateBudget: function() {
            ...
            // Calculate the percentage of that income that we spent
            if(data.total.inc > 0) {
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    updatePercentages = function() {
        ...
        //3. Update the UI from  the new percentage
    ...
    var ctrlAddItem = function() {
        ...
        if(input.description !== "" && !isNaN(input.value) && input.value > 0) {
            ...
            // 3. Add items to the UIController
            UICtrl.addItem(newItem, input.type);

            //Clear Field
            UICtrl.clearField();

            // 4. Calculate the budget and update
            updateBudget();

            // 5. Calculate the percentage and update
            updatePercentages();
        }
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if(itemID) {
            ...
            //4. Calculate the percentage and update
            updatePercentages();
